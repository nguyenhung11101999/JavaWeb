			...
			<div class="contentsp">
				<div class="leftsp">
					<fieldset>
						...
						<div class="subsp">
							<ul>
								<li><img id="image1" onclick="changeImage('image1');"
									src="images/1.jpg"></li>
								<li><img id="image2" onclick="changeImage('image2');"
									src="images/2.jpg"></li>
								<li><img id="image3" onclick="changeImage('image3');"
									src="images/3.jpg"></li>
								<li><img id="image4" onclick="changeImage('image4');"
									src="images/4.jpg"></li>
								<li><img id="image5" onclick="changeImage('image5');"
									src="images/5.jpg"></li>
							</ul>
						</div>
					</fieldset>
						...
						<div class="right2sp">
							...
							<div>
								<fieldset>
									...
									<label>Đen</label> <input type="checkbox" name="color"
										value="Đen"> <label>Đỏ</label> <input type="checkbox"
										name="color" value="Đỏ"> <label>Trắng</label> <input
										type="checkbox" name="color" value="Trắng"> <label>Vàng</label>
		...
		<script type="text/javascript">
			function changeImage(imageId) {
				...
				document.getElementById('image4').setAttribute("style",
						"border: 1px solid white");
				document.getElementById('image5').setAttribute("style",
						"border: 1px solid white");
				//dat lai duong vien cua the html co id vua click
				document.getElementById(imageId).setAttribute("style",
